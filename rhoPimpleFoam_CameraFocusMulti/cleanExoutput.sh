OUTPUT_DIR="../realistic-s3/ex_Output"
...
# ffmpeg -framerate 20 -pattern_type glob -i "../realistic-s3/ex_Output/Output/output_*_999999_*.bmp" -vcodec libx264 -pix_fmt yuv420p -r 60 40*40_5_0_0.4_0.3_0.3.mp4